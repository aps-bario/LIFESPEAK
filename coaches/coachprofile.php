...
<DIV class="content">
   ...
   <table>
   <tr>
      <td width=120><!--<a href="../images/AndrewPSmith.jpg" target="Andrew Smith - Life Coach">--><img src="../images/AndrewPSmith.jpg" width=120/><!--</a>--></td>
      <td>
      <table width=150 border="0" cellspacing="0" cellpadding="0" style="margin-left:25">
         <tr> 
          <td height="10"> <input checked name="goals" type="checkbox" 
        ...
        <tr> 
          <td width="25" height="10"> <input checked name="relations" type="checkbox" 
        ...
        <tr> 
          <td width="25" height="10"> <input name="career" type="checkbox" 
        ...
        <tr> 
          <td height="10"> <input name="cross-cultural" type="checkbox" 
        ...
        <tr> 
         ...
         <tr> 
          <td width="25" height="10"> <input checked name="spiritual" type="checkbox" 
        ...
        <tr> 
          <td width="25" height="10"> <input checked name="worklife" type="checkbox" 
